            ...
            <div id="main-content-inner">
                <div class="main-content-top clearfix">
                    <div class="breadcrumb clearfix">
                        ...
                        <a href="entretenimento.php" class="active">Política</a><span class="current-page">&nbsp;&raquo;&nbsp;&nbsp;Política</span>
                    </div><!--breadcrumb-->
                    ...
                    <div class="container col-sm-12">
                        ...
                        <section class="widget featured-widget">
                            <h3 class="widget-title"><span>Política</span></h3>
                                        ...
                                        <li>
                                            <article class="entry-item">
                                                <header class="clearfix">
                                                    <a href="noticias.php?noticia=<?php echo $d['noticia_id'] ?>"><img src=<?php echo $d['thumbnail'] ?> class="responsive-img hover-img img-responsive" alt="" /></a>
