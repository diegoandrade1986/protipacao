            ...
            <div id="main-content-inner">
                <div class="main-content-top clearfix">
                    <div class="breadcrumb clearfix">
                        ...
                        <a href="entretenimento.php" class="active">Entretenimento</a><span class="current-page">&nbsp;&raquo;&nbsp;&nbsp;Entretenimento</span>
                    </div><!--breadcrumb-->
                    ...
                    <div class="container col-sm-12">
                        ...
                        <section class="widget featured-widget">
                            <h3 class="widget-title"><span>Entretenimento</span></h3>
